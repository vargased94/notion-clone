    ...
    <div className="flex min-h-screen dark">
      ...
      <div className="flex w-full flex-col items-center justify-center bg-notion-bg-primary p-8 lg:w-1/2 lg:p-16">
        <form onSubmit={handleSubmit} className="flex w-full max-w-[380px] flex-col gap-5">
          <div>
            <h2 className="font-mono text-2xl font-bold text-notion-text-primary">Create your account</h2>
            <p className="mt-1 font-mono text-sm text-notion-text-secondary">Start organizing your work and ideas</p>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-mono text-xs text-notion-text-secondary">Full name</label>
            <input
              type="text"
              value={fullName}
          ...
          <label className="flex items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-notion-border-light accent-notion-green-primary"
            />
            <span className="font-mono text-xs text-notion-text-muted">
          ...
          <p className="text-center font-mono text-xs text-notion-text-muted">
            ...
            <Link to="/login" className="font-semibold text-notion-green-primary hover:underline">
              Sign in
            </Link>
          </p>
        </form>
